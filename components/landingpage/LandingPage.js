        ...
        <div className={styles.lpPage}>
            <div className={styles.firstsection}>
                <div className={styles.left}>
                    ...
                    <p>boomrng&trade; is reimagining the time consuming task of finding the right greeting card or invitation. Why go from store to store anymore just to find the right card and gift for that special someone or occasion?</p>
